...
#include <vulkan/vulkan_win32.h>
 ...
 static int ImGui_ImplVulkan_CreateSurface(ImGuiViewport* viewport, ImU64 vk_instance, const void* vk_allocator, ImU64* out_vk_surface) 
 { 
     ImGui_ImplVulkan_ViewportData* vd = (ImGui_ImplVulkan_ViewportData*)viewport->PlatformUserData; 
	...
	createInfo.flags = 0;
	createInfo.hinstance = ::GetModuleHandle(nullptr); //FIXME
	createInfo.hwnd = (HWND)viewport->PlatformHandle;


     VkResult ret = vkCreateWin32SurfaceKHR( (VkInstance)vk_instance, &createInfo, NULL, (VkSurfaceKHR*)out_vk_surface );
     return ret ? VK_SUCCESS : VK_NOT_READY;
 } 
...
void ImGui_ImplVulkan_InitPlatformInterface()
{
	...
	platform_io.Platform_CreateVkSurface = ImGui_ImplVulkan_CreateSurface;
